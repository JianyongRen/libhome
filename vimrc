...
"hi cComment cterm=bold ctermfg=6 guifg=Green
hi cComment cterm=bold ctermfg=4 guifg=Blue
...
" => Text, tab and indent related
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"set expandtab	"space replace the tab
"set smarttab
...
function! CppFold() 
    ...
    setl foldlevel=65536	"first open not fold，第一次打开不折行

    function! CppFoldText()
    return substitute(getline(v:foldstart), '{.*', '{...}', '')
    endfunction
    setl foldtext=CppFoldText()
endfunction

au FileType c call CppFold()
...
"let Tlist_Ctags_Cmd = '/usr/bin/cscope'
...
"let Tlist_WinWidth+=21<CR>                 "taglist窗口宽度
